...
# 2. 환경변수
DATABASE_BRONZE = 'de_ai_09_ma_bronze_db'
    ...
    ctas_silver_task = AthenaOperator(
        ...
        query='''
            ...
            with(
                ...
                pattitionde_by = ARRAY['dt','hr']
            )
            As
            Select event_id,
            event_time as event_time_timestamp,
            data.user_id,
            data.item_id,
            data.price,
            data.qty, 
        ...
        ''',
        database = DATABASE_SILVER,
        params = {'database_silver':DATABASE_BRONZE, 'database_silver':DATABASE_SILVER, 'tbl_nm':SILVER_TBL_NAME, 'silver_path':ATHENA_RESULTS}
    )
